---
title: "Early diet Western diet on young mice Cortex (show code)"
output:
...
```{r QC2  pearson correlation, fig.width=7, fig.height=6, out.width="6in"}
...
```{r Explore the GLM model- heatmap, fig.width=5, fig.height=7, out.width="4.5in"} 
...
```{r Explore the GLM model- VennDiagram and Tile plot, fig.width=8, fig.height=7, out.width="6in", fig.align="center"}
...
```{r heat map, fig.width=10, fig.height=12, out.width="7in"}
# heatmap 
logCPM <- log.cpm
